...
declare module "@salesforce/label/c.Restricted_Edit_Upload_Files_Objects" {
    var Restricted_Edit_Upload_Files_Objects: string;
    export default Restricted_Edit_Upload_Files_Objects;
}
declare module "@salesforce/label/c.Upcoming_Overdue" {
    var Upcoming_Overdue: string;
    export default Upcoming_Overdue;
}
declare module "@salesforce/label/c.Users_Exclusion" {
    var Users_Exclusion: string;
    export default Users_Exclusion;
}
declare module "@salesforce/label/c.View_All_Text" {
    var View_All_Text: string;
    export default View_All_Text;
}
