({
	doInit : function(component, event, helper) {
        component.set('v.systemProductColoums',[
        ...
        helper.getAllRProducts(component);
	},
    ...
    onProductSeletion:function(component,event,helper){
        ...
        helper.setProduct(component,selectedRows);
    },
    addNewSubRow:function(component,event,helper){
        //remove blank row from list
        let index=event.getSource().get('v.value');
        helper.setSubProductList(component,index);
        //component.set('v.newProductList',);
    }
